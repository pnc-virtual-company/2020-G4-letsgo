        ...
        <div class="col-12 mt-4">
            ...
            <div class="card mt-3">
                <div class="container">
                    <div class="row">
                        <div class="col-10">
                            <div class="container" data-toggle="modal" data-title="{{$event->title}}" data-image="{{$event->eventPicture}}" 
                                data-location="{{$event->location}}" data-members="{{$event->numberOfMember}}" data-organizer="{{$event->organizer}}" 
                                data-category="{{$event->Category['name']}}" data-decription="{{$event->description}}" 
                                data-startdate="{{$event->startDate}}" data-users="{{$users}}" data-starttime="
